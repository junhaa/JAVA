...
public class Main {
				...
				for(int i = 0 ; i < 4 ; i ++) {
					...
					case 0: { // UP
						...
						if(tmpRed != null && tmpBlue != null) { 
							if(tmpRed.x != tmp.red.x || tmpRed.y != tmp.red.y || tmpBlue.x != tmp.blue.x || tmpBlue.y != tmp.blue.y) Q.offer(new Ball(tmpRed, tmpBlue));
						}
						break;
					}
					case 1: { // RIGHT
	...
	public static void main(String[] args) throws IOException {
		...
		int L = T.solution(red, blue);
		if(L == -1) System.out.println(0);
